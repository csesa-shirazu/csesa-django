...
from csesa.settings import SEND_TO_CHAT_ID, CHANNEL_USER_NAME
...
class PostListView(ListView):
    model = Post
    template_name = 'telegramboard/home.html'
...
class PostCreateView(CreateView):
    ...
    def form_valid(self, form):
        ...
        if not flag:
            ...
            return render(self.request, 'telegramboard/error.html')
        ########################################################################
...
def ContactView(request):
    return render(request, 'telegramboard/contact.html')
